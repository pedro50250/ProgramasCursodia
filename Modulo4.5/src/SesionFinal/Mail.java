...
public class Mail {
	...
	public void sendMailComp(String _email,String _nombre, String _usuario, String _contraseña) throws IOException
	{
		...
		Session session = Session.getInstance(props,new javax.mail.Authenticator(){
			...
			{
				return new PasswordAuthentication(_usuario,_contraseña);
			}
		});
