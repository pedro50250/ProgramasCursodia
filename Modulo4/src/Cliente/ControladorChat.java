...
public class ControladorChat implements ActionListener,KeyListener{
	...
	public ControladorChat(VistaChat vista, ModeloChat modelo)
	{
		...
		/*while(true)
		{
			...
			if(this.modelo.Mensaje==true)
			{
				...
				this.appendToPane("" + this.modelo.nomServer, Color.BLUE);
	...
	{
		this.modelo.conectar(this);
		this.modelo.recibirNombre();
		this.modelo.abrirHilo(this.modelo);
	}
	
	private void añadirUsuarioTabla()
	{
		...
		model.addRow(new Object[] { "" + this.modelo.nomServer});
	}
