...
public class Ventas extends JFrame {
	...
	public Ventas() {
		...
		scrollPane.setBounds(5, 128, 664, 259);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"ID venta", "ID Usuario", "Cantidad Articulos", "Monto", "Fecha"
			}
		) {
		...
		scrollPane_1.setBounds(5, 412, 664, 149);
		...
		tableDetalle.setModel(new DefaultTableModel(
			...
			new String[] {
				"ID VENTA", "ID ARTICULO", "CANTIDAD", "PRECIO UNITARIO"
			}
		));
		...
		cbxPrimary.setModel(new DefaultComboBoxModel(new String[] {"ID VENTA", "USUARIO", "ARTICULOS", "MONTO", "FECHA"}));
		...
		cbxRango.setModel(new DefaultComboBoxModel(new String[] {"DIA", "MES", "AÑO","TODOS"}));
